...
class DeepSeekV4CompressedComponent(TreeComponent):
    ...
    def build_hicache_transfers(
        ...
        if phase == CacheTransferPhase.BACKUP_HOST:
            ...
            return [
                PoolTransfer(name=PoolName.DEEPSEEK_V4_C4, device_indices=page_dev),
                PoolTransfer(
                    name=PoolName.DEEPSEEK_V4_INDEXER, device_indices=page_dev.clone()
                ),
                PoolTransfer(name=PoolName.DEEPSEEK_V4_C128, device_indices=page_dev.clone()),
            ]
        ...
        if phase == CacheTransferPhase.LOAD_BACK:
            ...
            return [
                PoolTransfer(name=PoolName.DEEPSEEK_V4_C4, host_indices=page_host),
                PoolTransfer(
                    name=PoolName.DEEPSEEK_V4_INDEXER, host_indices=page_host.clone()
                ),
                PoolTransfer(name=PoolName.DEEPSEEK_V4_C128, host_indices=page_host.clone()),
            ]
